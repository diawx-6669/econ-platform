          ...
          quiz: [
            {
              ...
              options: [
                "Потому что люди по природе жадные и никогда не бывают довольны",
                "Потому что ресурсы ограничены, а потребности безграничны",
                "Потому что государство печатает недостаточно денег для всех покупок",
                "Потому что в стране физически не хватает магазинов и торговых точек"
              ],
              correct: 1,
            ...
            },
            {
              ...
              options: ["Что производить обществу", "Как производить наиболее эффективно", "Когда закрывать биржу", "Для кого производить полученные блага"],
              correct: 2,
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["Полная балансовая стоимость завода и оборудования", "Упущенные 500 наушников (в пересчёте на выгоду от них)", "Зарплата рабочих, занятых на конвейере", "Ничего — ресурсы компании ничем не ограничены"],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: [
                "Экономика работает эффективно на самом пределе возможностей",
                "Ресурсы используются не полностью (например, безработица)",
                "Комбинация недостижима при нынешних ресурсах и технологиях",
                "Технологии значительно улучшились за последний год"
              ],
              correct: 1,
            ...
            },
            {
              ...
              options: [
                "Временное снижение цен на товары в магазинах",
                "Технологический прогресс или рост ресурсов",
                "Перераспределение бюджета между товарами",
                "Увеличение импорта одного конкретного товара"
              ],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: ["Возникнет избыток предложения на рынке аренды", "Возникнет дефицит — спрос превысит предложение", "Ничего не изменится, рынок останется прежним", "Цена сама постепенно вырастет обратно до старого уровня"],
              correct: 1,
            ...
            },
            {
              ...
              options: [
                "Цена находится на своём историческом максимуме",
                "Объём спроса равен объёму предложения",
                "Государство фиксирует цену законодательно",
                "Продавцов на рынке значительно больше, чем покупателей"
              ],
              correct: 1,
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["Соль для повседневной готовки еды", "Хлеб на завтрак каждый день", "Поход в ресторан премиум-класса", "Инсулин по рецепту врача"],
              correct: 2,
          ...
          quiz: [
            {
              ...
              options: [
                "Она растёт вместе с ростом цен на товары",
                "Она снижается — на ту же сумму купишь меньше",
                "Практически не меняется со временем",
                "Зависит исключительно от курса доллара к рублю"
              ],
              correct: 1,
            ...
            },
            {
              ...
              options: ["Значительным ростом доходов населения", "Удорожанием сырья и производственных затрат", "Существенным снижением налогов на весь бизнес", "Быстрым ростом сбережений населения"],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: ["Цены вырастут примерно в 1.1 раза", "Примерно в 2 раза", "Цены вырастут примерно в 10 раз", "Цены останутся примерно на том же уровне"],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: ["Инфляция, скорее всего, ускорится в ближайшие месяцы", "Инфляция должна замедлиться", "Ключевая ставка никак не повлияет на инфляцию", "Цены на все товары упадут до нуля"],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: [
                "Сложный процент начисляется значительно реже, чем простой процент",
                "Сложный процент начисляется и на проценты, не только на сумму",
                "Сложный процент доступен только крупным банкам",
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: [
                "Так требует закон о личных финансах и бюджете",
                "Чтобы деньги не разошлись на мелочи до зарплаты",
                "Это не имеет значения, оба варианта равноценны",
                "Банки обычно платят больше процентов в начале месяца"
              ],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: [
                "Абсолютное преимущество каждой страны буквально во всём",
                "Сравнительное преимущество: специализация там, где ниже издержки",
                "Значительные государственные субсидии для экспортёров-производителей",
                "Полностью одинаковая производительность труда во всех странах"
              ],
              correct: 1,
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: ["Только иностранные производители и импортёры", "Отечественные производители и бюджет", "Только конечные потребители товаров", "Все участники рынка выигрывают одинаково"],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: [
                "Экспорт станет значительно менее конкурентоспособным на рынке",
                "Экспорт подешевеет для иностранцев и станет конкурентнее",
                "Ослабление валюты никак не повлияет на экспорт",
                "Импорт для местных покупателей подешевеет"
              ],
              correct: 1,
            ...
            },
            {
              ...
              options: [
                ...
                "Общий государственный долг страны",
                "Официальный курс национальной валюты",
                "Текущий уровень безработицы в стране"
              ],
              correct: 0,
        ...
        },
        {
          ...
          quiz: [
            ...
            },
            {
              ...
              options: [
                "Число рабочих мест заметно вырастет",
                "Число рабочих мест сократится — часть желающих не найдёт работу",
                "Ничего не изменится на рынке труда",
                "Зарплаты сами постепенно снизятся до прежнего равновесного уровня"
              ],
              correct: 1,
          ...
          quiz: [
            {
              ...
              options: [
                "ВВП, как правило, растёт",
                "ВВП падает относительно потенциального уровня",
                "ВВП вообще не связан с уровнем безработицы",
                "Связь работает исключительно в обратную сторону"
              ],
              correct: 1,
            ...
            },
            {
              ...
              options: [
                "Да, коэффициент абсолютно всегда одинаков",
                "Нет — это эмпирическая, а не жёсткая закономерность",
                "Он относится исключительно только к денежно-кредитной политике",
